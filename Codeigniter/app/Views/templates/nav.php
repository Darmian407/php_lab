        ...
        <nav class="uk-navbar-container" uk-navbar>
            ...
            <div class="uk-navbar-right">
                ...
                <ul class="uk-navbar-nav">
                    ...
                    <li><a class="uk-visible@s" href="/perfil_usuario">Perfil</a></li>
                    <li><a class="uk-visible@s" href="/login">Iniciar Sesión</a></li>
                    <li><a class="uk-visible@s" href="/register">Registrarse</a></li>
                    <li><a class="uk-visible@s" href="#">Cerrar sesión</a></li>
                </ul>

            </div>

            <button class="uk-button uk-button-default uk-hidden@s" type="button"
                uk-toggle="target: #offcanvas-flip"><span uk-icon="table"></span></button>
